      ...
      <section className="mx-auto max-w-5xl px-6 py-10 sm:py-14">
        ...
        <aside className="mt-8 rounded-[22px] border border-amber-400/20 bg-amber-500/5 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] backdrop-blur-sm">
          ...
          <p className="mt-3 text-xs text-amber-100/70">
            Dataset: <span className="font-medium text-amber-100">Multimodal Sports Injury Prediction Dataset</span> (Bhegam et al., 2025, Kaggle). Licensed under CC BY-NC-SA 4.0 — non-commercial use with attribution required.
          </p>
        </aside>
      </section>
    </main>
